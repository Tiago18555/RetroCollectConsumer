...
public partial class WishlistConsumerService: IConsumerService
{
    private readonly IRequestProcessorFactory _processorFactory;
    private readonly ILogger<WishlistConsumerService> _logger;
    private readonly IConsumer<Ignore, string> _consumer;
    private readonly ConsumerConfig _consumerConfig;
    private readonly IConfiguration _configuration;
    private readonly Parameters _parameters;

    public WishlistConsumerService(
        ILogger<WishlistConsumerService> logger, 
    ...
    public async Task ConsumeAsync(CancellationToken cts)
    {
        ...
        while (!cts.IsCancellationRequested)
        {
            ...
            {
                StdOut.Error($"WISHLIST CONSUMER WORKER CANCELED");
            }
        }
