...
public partial class CollectionConsumerService: IConsumerService
{
    private readonly IRequestProcessorFactory _processorFactory;
    private readonly ILogger<CollectionConsumerService> _logger;
    private readonly IConsumer<Ignore, string> _consumer;
    private readonly ConsumerConfig _consumerConfig;
    private readonly IConfiguration _configuration;
    private readonly Parameters _parameters;

    public CollectionConsumerService(
        ILogger<CollectionConsumerService> logger, 
    ...
    public async Task ConsumeAsync(CancellationToken cts)
    {
        ...
        while (!cts.IsCancellationRequested)
        {
            ...
            {
                StdOut.Error($"COLLECTION CONSUMER WORKER CANCELED");
            }
        }
