...
public static class ManageUserCollectionHelper
{
    ...
    {
        if (typeof(TSource) == typeof(UpdateGameRequest) && typeof(TTarget) == typeof(GameCollectionItem))
        {
        ...
        if (typeof(TSource) == typeof(UpdateComputerRequest) && typeof(TTarget) == typeof(ComputerCollectionItem))
        {
            var userComputer = target as ComputerCollectionItem;
        ...
        if (typeof(TSource) == typeof(UpdateConsoleRequest) && typeof(TTarget) == typeof(ConsoleCollectionItem))
        {
            var userConsole = target as ConsoleCollectionItem;
